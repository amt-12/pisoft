      ...
      <div className="relative max-w-5xl mx-auto text-center">
        <div className="relative h-80 grid place-items-center mb-12">
          <motion.div
            ...
            className="absolute size-64 rounded-full bg-[image:var(--gradient-primary)] blur-3xl opacity-60"
          />
          {modules.map((m, i) => {
            ...
            return (
              <motion.div
                ...
                className="absolute rounded-full border border-border bg-surface/80 backdrop-blur px-4 py-2 text-xs"
              >
                {m}
              </motion.div>
            );
          ...
          <motion.div
            ...
            className="relative size-24 rounded-full bg-[image:var(--gradient-primary)] glow-primary grid place-items-center"
          >
            <span className="font-display font-bold text-sm">Pisoft</span>
          </motion.div>
        </div>
